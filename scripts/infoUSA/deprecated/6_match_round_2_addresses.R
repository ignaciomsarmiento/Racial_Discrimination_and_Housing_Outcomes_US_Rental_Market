...
# Keep not matched --------------------------------------------------------
# dta<-read_dta(here("stores/matchedinquiries_infoUSA.dta"))
# 
# not_matched<-dta %>%  filter(ethnicity_infoUSA=='') %>% distinct(Address,
#                                                                     City,
#                                                                     State,
#                                                                     Zip_Code,
#                                                                     dir,
...
#                                                                     Longitude)
# 
# saveRDS(not_matched,here("stores/infoUSA/not_matched.rds"))


# read data to match ---------------------------------------------------------------
addresses<-readRDS(here("stores/infoUSA/not_matched.rds"))
...
save.image(here("stores/infoUSA_strings_not_unit.rds"))
