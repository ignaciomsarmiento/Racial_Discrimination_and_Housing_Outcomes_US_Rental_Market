...
tabulate cbsa_quart_singleparent_share , gen(quart_single)
...
forvalues i=1/4{
	...
	************************************************************************************************
	...
	twoway  (rarea afam_lci afam_uci quartiles, color(gray%20))  ///
			...
			xtitle(Within CBSA quartile Single Parent Share) ///
			ytitle(Relative Responses) ///
			scheme(plotplain) ///
			yscale(range(-0.20(.025)0.025)) ylabel(-0.20(0.025)0.025) 
	graph export views/quartiles_single_parent_blacks.png, width(800) replace
	...
	twoway  (rarea hispanic_lci hispanic_uci quartiles, color(gray%20))  ///
			...
			scheme(plotplain) ///
			yscale(range(-0.20(.025)0.025)) ylabel(-0.20(0.025)0.025) 
	graph export views/quartiles_single_parent_hispanic.png, width(800) replace
