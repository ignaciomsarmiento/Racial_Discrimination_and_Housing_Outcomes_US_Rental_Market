...
gen changewhiterentersshare=(whiterentersshare2014_2018- whiterentersshare2009_2013)

gen qwhitepopchange=(changewhiterentersshare<=-0.10)
replace qwhitepopchange=2 if changewhiterentersshare>-0.10 & changewhiterentersshare<0.10
replace qwhitepopchange=3 if changewhiterentersshare>=0.10
...
*Tables of coeficients
  ...
  #delimit ; 
esttab modelRR
         using "${path_tables}/table_whiterentershare_10.tex", 
         style(tex) 
         ...
         stats(mean_white1
               ...
               labels("Mean Response (White) $\Delta White Renter Share< -0.10$"
                      "Mean Response (White) $\Delta White Renter Share\in [-0.10,0.10]$"
                      "Mean Response (White) $\Delta White Renter Share>0.10$"
                     "\hline Gender" 
                     "Education Level" 
                     "Inquiry Order"
                     "Address"
         ...
         eqlabels(,none)
         varlabels(
                   RR_AfAm_qwhitepopchange1  "African American $\times \Delta White Renter Share< -0.10$"
                   RR_AfAm_qwhitepopchange2  "African American $\times \Delta White Renter Share\in [-0.10,0.10]$"
                   RR_AfAm_qwhitepopchange3  "African American $\times \Delta White Renter Share>0.10$"
                   RR_Hispanic_qwhitepopchange1  "Hispanic/LatinX $\times \Delta White Renter Share< -0.10$"
                   RR_Hispanic_qwhitepopchange2  "Hispanic/LatinX $\times \Delta White Renter Share\in [-0.10,0.10]$"
                   RR_Hispanic_qwhitepopchange3  "Hispanic/LatinX $\times \Delta White Renter Share> 0.10$"
                   ) 
         starl(* 0.1 ** 0.05 *** 0.01)   
         ...
         prehead( 
          ...
          \captionsetup{justification=centering}
            \caption{Response Rates by Changes White Renter Share}
            \label{tab:change_white_renter_share_10}
