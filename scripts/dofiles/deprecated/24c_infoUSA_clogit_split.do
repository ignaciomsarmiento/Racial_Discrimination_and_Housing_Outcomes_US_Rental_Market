...
reghdfe choice   White_Black  AfAm_White  if Hispanic==0 ,  absorb(  Address) 

reghdfe choice   White_Hispanic   Hispanic_White  if AfAm==0 ,  absorb(  Address) 

keep if black_infoUSA==1 | white_infoUSA==1
keep if Hispanic==0
clogit choice    White_Black  AfAm_White AfAm_Black     , group(Address)   cl(CBSA_downtown) level(90) 
