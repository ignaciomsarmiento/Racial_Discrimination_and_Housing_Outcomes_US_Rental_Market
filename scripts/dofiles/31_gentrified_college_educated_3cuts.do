...
gen changewhiterentersshare=(college2014_2018- college2009_2013)
...
*Tables of coeficients
  ...
  #delimit ; 
esttab modelRR
         using "${path_tables}/table_collegeshare_02.tex", 
         style(tex) 
         ...
         stats(mean_white1
               ...
               labels("Mean Response (White) $\Delta College Share< -0.02$"
                      "Mean Response (White) $\Delta College Share\in [-0.02,0.02]$"
                      "Mean Response (White) $\Delta College Share>0.02$"
                     "\hline Gender" 
                     "Education Level" 
                     "Inquiry Order"
                     "Address"
         ...
         eqlabels(,none)
         varlabels(
                   RR_AfAm_qwhitepopchange1  "African American $\times \Delta College Share< -0.02$"
                   RR_AfAm_qwhitepopchange2  "African American $\times \Delta College Share\in [-0.02,0.02]$"
                   RR_AfAm_qwhitepopchange3  "African American $\times \Delta College Share>0.02$"
                   RR_Hispanic_qwhitepopchange1  "Hispanic/LatinX $\times \Delta College Share< -0.02$"
                   RR_Hispanic_qwhitepopchange2  "Hispanic/LatinX $\times \Delta College Share\in [-0.02,0.02]$"
                   RR_Hispanic_qwhitepopchange3  "Hispanic/LatinX $\times \Delta College Share> 0.02$"
                   ) 
         starl(* 0.1 ** 0.05 *** 0.01)   
         ...
         prehead( 
          ...
          \captionsetup{justification=centering}
            \caption{Response Rates by Changes College Share}
            \label{tab:change_college_share_02}
