...
foreach race in black white{
	...
	tabulate cbsa_quart_share_`race' , gen(quart_`race')

	tab2xl cbsa_quart_share_`race'  using views/table_share_black_`race', col(1) row(1) 
	...
	************************************************************************************************
	...
	graph export views/quartiles_share_black_`race'.png, width(800) replace
