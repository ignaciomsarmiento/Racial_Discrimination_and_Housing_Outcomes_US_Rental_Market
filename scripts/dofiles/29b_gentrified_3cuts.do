...
gen qwhitepopchange=(whitepopchange<=-0.02)
replace qwhitepopchange=2 if whitepopchange>-0.02 & whitepopchange<0.02
replace qwhitepopchange=3 if whitepopchange>=0.02
...
*Tables of coeficients
  ...
  #delimit ; 
esttab modelRR
         using "${path_tables}/table_whitepopchange_02.tex", 
         style(tex) 
         ...
         stats(mean_white1
               ...
               labels("Mean Response (White) $\Delta White Pop< -0.02$"
                      "Mean Response (White) $\Delta White Pop\in [-0.02,0.02]$"
                      "Mean Response (White) $\Delta White Pop>0.02$"
                     "\hline Gender" 
                     "Education Level" 
                     "Inquiry Order"
                     "Address"
         ...
         eqlabels(,none)
         varlabels(
                   RR_AfAm_qwhitepopchange1  "African American $\times \Delta White Pop< -0.02$"
                   RR_AfAm_qwhitepopchange2  "African American $\times \Delta White Pop\in [-0.02,0.02]$"
                   RR_AfAm_qwhitepopchange3  "African American $\times \Delta White Pop>0.02$"
                   RR_Hispanic_qwhitepopchange1  "Hispanic/LatinX $\times \Delta White Pop< -0.02$"
                   RR_Hispanic_qwhitepopchange2  "Hispanic/LatinX $\times \Delta White Pop\in [-0.02,0.02]$"
                   RR_Hispanic_qwhitepopchange3  "Hispanic/LatinX $\times \Delta White Pop> 0.02$"
                   ) 
         starl(* 0.1 ** 0.05 *** 0.01)   
