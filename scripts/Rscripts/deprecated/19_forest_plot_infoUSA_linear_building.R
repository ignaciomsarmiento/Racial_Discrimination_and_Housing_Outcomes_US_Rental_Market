...
# Full Sample -------------------------------------------------------------
dta1<-read_dta("stores/matrices/temp/RR_rel_full_sample_building.dta") %>% 
...
# Below Median ------------------------------------------------------------
#Minority share
dta20<-read_dta("stores/matrices/temp/min_sh_1_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="min")
#AfAm share
dta21<-read_dta("stores/matrices/temp/bk_sh_1_building.dta") %>% 
      mutate(sample="Same Race \n Population Share \n Below Median") %>% 
      filter(race=="afam")
#Hispanic share
dta22<-read_dta("stores/matrices/temp/hisp_sh_1_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="hisp")
#White share
dta23<-read_dta("stores/matrices/temp/hisp_sh_1_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="white")
...
# Above Median ------------------------------------------------------------
#Minority share
dta30<-read_dta("stores/matrices/temp/min_sh_2_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="min")
#AfAm share
dta31<-read_dta("stores/matrices/temp/bk_sh_2_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="afam")
#Hispanic share
dta32<-read_dta("stores/matrices/temp/hisp_sh_2_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="hisp")
#White share
dta33<-read_dta("stores/matrices/temp/hisp_sh_2_building.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median")%>% 
  filter(race=="white")
pop_share_above<-rbind(dta30,dta31,dta32,dta33)
rm(dta30,dta31,dta32,dta33)   
...
# # -----------------------------------------------------------------------
# Below Median ------------------------------------------------------------
medinc_below<-read_dta("stores/matrices/temp/medinc_1_building.dta") %>% 
  mutate(sample="Median Income \n Below Median") 
# Above Median ------------------------------------------------------------
medinc_above<-read_dta("stores/matrices/temp/medinc_2_building.dta") %>% 
  mutate(sample="Median Income \n Above Median") 
...
# # -----------------------------------------------------------------------
# Below Median ------------------------------------------------------------
rent_sqf_below<-read_dta("stores/matrices/temp/rent_sqf_1_building.dta") %>% 
  mutate(sample="Rent per Sqft. \n Below Median") 
# Above Median ------------------------------------------------------------
rent_sqf_above<-read_dta("stores/matrices/temp/rent_sqf_2_building.dta") %>% 
  mutate(sample="Rent per Sqft. \n Above Median") 
...
# Downtown/Suburb ---------------------------------------------------------
downtown<-read_dta("stores/matrices/temp/Downtown_building.dta") %>% 
  mutate(sample="Downtown") 

suburb<-read_dta("stores/matrices/temp/Suburb_building.dta") %>% 
  mutate(sample="Suburb") 


# Regions -----------------------------------------------------------------
   
midwest<-read_dta("stores/matrices/temp/Midwest_building.dta") %>% 
  mutate(sample="Midwest") 

northeast<-read_dta("stores/matrices/temp/Northeast_building.dta") %>% 
  mutate(sample="Northeast") 

south<-read_dta("stores/matrices/temp/South_building.dta") %>% 
  mutate(sample="South") 

west<-read_dta("stores/matrices/temp/West_building.dta") %>% 
  mutate(sample="West") 
...
ggsave(plot=grob,"views/infoUSA_forest_linear_building.pdf",height = 16,width = 12)
...
ggsave(plot=grob_min,"views/infoUSA_forest_linear_building_min.pdf",height = 4,width = 12)
