...
# Below Median ------------------------------------------------------------
#Minority share
dta20<-read_dta("stores/matrices/temp/min_sh_1_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="min")
#AfAm share
dta21<-read_dta("stores/matrices/temp/bk_sh_1_by_cbsa.dta") %>% 
      mutate(sample="Same Race \n Population Share \n Below Median") %>% 
      filter(race=="afam")
#Hispanic share
dta22<-read_dta("stores/matrices/temp/hisp_sh_1_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="hisp")
#White share
dta23<-read_dta("stores/matrices/temp/hisp_sh_1_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Below Median") %>% 
  filter(race=="white")
...
# Above Median ------------------------------------------------------------
#Minority share
dta30<-read_dta("stores/matrices/temp/min_sh_2_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="min")
#AfAm share
dta31<-read_dta("stores/matrices/temp/bk_sh_2_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="afam")
#Hispanic share
dta32<-read_dta("stores/matrices/temp/hisp_sh_2_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median") %>% 
  filter(race=="hisp")
#White share
dta33<-read_dta("stores/matrices/temp/hisp_sh_2_by_cbsa.dta") %>% 
  mutate(sample="Same Race \n Population Share \n Above Median")%>% 
  filter(race=="white")
...
# # -----------------------------------------------------------------------
# Below Median ------------------------------------------------------------
medinc_below<-read_dta("stores/matrices/temp/medinc_1_by_cbsa.dta") %>% 
  mutate(sample="Median Income \n Below Median") 
# Above Median ------------------------------------------------------------
medinc_above<-read_dta("stores/matrices/temp/medinc_2_by_cbsa.dta") %>% 
  mutate(sample="Median Income \n Above Median") 
...
# # -----------------------------------------------------------------------
# Below Median ------------------------------------------------------------
rent_sqf_below<-read_dta("stores/matrices/temp/rent_sqf_1_by_cbsa.dta") %>% 
  mutate(sample="Rent per Sqft. \n Below Median") 
# Above Median ------------------------------------------------------------
rent_sqf_above<-read_dta("stores/matrices/temp/rent_sqf_2_by_cbsa.dta") %>% 
  mutate(sample="Rent per Sqft. \n Above Median") 
...
ggsave(plot=grob,"views/infoUSA_forest0_linear_by_cbsa.pdf",height = 16,width = 12)
